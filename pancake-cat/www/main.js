...
const APP_NAME = "Pancake Cat Mod";
const APP_VERSION = "1.0.0";
const APP_AUTHOR = "Josh";
const APP_DESCRIPTION = "Catch falling pancakes - with Josh's mod";
const RESOLUTION = [256, 144];
const WASM_SRC = "hello_world.wasm";

const SPRITES = ["./sprites/heart.png","./sprites/munch_cat.png",];
